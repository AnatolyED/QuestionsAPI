...
using QuestionsAPI.Contracts;

namespace QuestionsAPI.Presenters.Controllers;
...
public class QuestionsController : ControllerBase
{
    ...
    public async Task<IActionResult> SeletSolution([FromRoute]Guid questionId, [FromQuery]Guid answerId, CancellationToken cancellationToken)
    {
